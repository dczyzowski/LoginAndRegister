...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean mayNeedInternetPermission() {
        ...
        if (shouldShowRequestPermissionRationale(INTERNET)) {
            Snackbar.make(mEmailView, R.string.permission_rationale_internet, Snackbar.LENGTH_INDEFINITE)
    ...
    public class UserLoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://testbazydanych123.netau.net/old/app/register.php");
                String response = "";

                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                String urlParams = "username="+mUsername+"&email="+mEmail+"&password="+mPassword;
                ...
                String[] temp1 = data.split("\"" , 6);
                String message = temp1[3];

                inputStream.close();
                conn.disconnect();

                if (message.equals("user_exist"))
                    return message;
        ...
        protected void onPostExecute(final String success) {
            ...
            if (success.equals("succes")) {
                finish();
            } else if(success.equals("user_exist")) {
                mUserNameView.setError(getString(R.string.error_incorrect_login));
                mUserNameView.requestFocus();
            }
            else if (success.equals("email_used")){
